    ...
    return(
        <main className='w-[29%]  bg-[#121212] rounded-lg p-4 pr-8 mx-2 '>
            <section className='flex flex-row justify-between items-center'>
                <div className='text-lg font-bold '>Your Library</div>
                 <div className='flex flex-row items-center'>
                    <div className='bg-[#1F1F1F] flex flex-row rounded-full p-2 mt-[-1] mr-4'>
            ...
            <section className='flex flex-row mt-4'>
                <div className='bg-[#2A2A2A] flex flex-row rounded-full px-4 py-1 mr-2 '>
                ...
                <div className='bg-[#2A2A2A] flex flex-row rounded-full px-4 py-1 '>
            ...
            <section className='flex flex-row justify-between mt-6'>
                ...
                <div className='flex flex-row '>
                    <h1 className='text-[#7B7B7B] mr-2 font-semibold text-base'>Recently added</h1>
                    <img className='w-5 h-5 mt-0.5' src={list} alt='list'></img>
                </div>
            </section>
            {/* <section>
                <Playlist/>
